...
These can be two independent URLs. In this case, I've used one URL and setup Caddy to route traffic to the correct port on the mediator. I think this setup is much more clear and easier to consume.
